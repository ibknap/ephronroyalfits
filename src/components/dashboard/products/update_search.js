...
export default function UpdateSearchProduct({ product }) {
  ...
  const onupdateSearchProduct = async (e) => {
    e.preventDefault();
    setLoading(true);
  ...
  return (
    <div
      ...
      id="updateSearchProduct"
      tabIndex="-1"
      aria-labelledby="updateSearchProductLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-lg modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title" id="updateSearchProductLabel">
              Update Product
            </h4>
            <button
              type="button"
          ...
          <form onSubmit={onupdateSearchProduct} ref={formRef}>
