                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col-sm-6">
                                        <div className="my-2 p-2 card">
                                            ...
                                            <hr />
                                            <span className="text-muted mb-2">{user.addressBook.firstName} {user.addressBook.lastName}</span>
                                            <span className="text-muted mb-2">{user.addressBook.address}</span>
                                            <span className="text-muted mb-2">{user.addressBook.additionalInformation}</span>
                                            <span className="text-muted mb-2">
                                                {user.addressBook.phoneNumber} / {user.addressBook.additionalPhoneNumber}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row mt-2">
                                    <div className="col-sm-6">
                                        <div className="my-2 p-2 card">
                                            ...
                                            <hr />
                                            <span className="text-muted mb-2">&#12539; Debit/credit card</span>
                                            <span className="text-muted mb-2">&#12539; Bank transfer</span>
                                            <span className="text-muted mb-2">&#12539; USSD transfer</span>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div className="my-2 p-2 card">
