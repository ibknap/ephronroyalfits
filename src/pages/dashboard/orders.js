...
import DashboardOrders from '@/components/dashboard/orders/orders';
...
export default function DashboardOrdersPage() {
    ...
    // page default data
    const pageName = "NEFB - Dashboard Orders";
    ...
    const pageURL = "https://northeastfoodbank.org/dashboard/orders";
    ...
    return (
        <>
            <Head>
                ...
                <meta name="keywords" content="Food bank, Orders, Charity, Nonprofit, Nigeria, Hunger, Poverty, North East, Community support, Food insecurity, Volunteer opportunities, Social impact, Humanitarian aid, Relief organization, Sustainable development" />
