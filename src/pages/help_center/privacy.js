...
import Privacy from '@/components/help_center/privacy';

export default function PrivacyPage() {
    // page default data
    const pageName = "NEFB - Privacy";
    const pageDesc = "View our current privacy policies, dos' and donts'.";
    const baseURL = "https://northeastfoodbank.org";
    const parentURL = "https://northeastfoodbank.org/help_center";
    const pageURL = "https://northeastfoodbank.org/help_center/privacy";
