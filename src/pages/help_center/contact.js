...
export default function ContactPage() {
    // page default data
    const pageName = "NEFB - Contact";
    const pageDesc = "Contact us at NEFB for any complaint, information or suggestions you want to make";
    const baseURL = "https://northeastfoodbank.org";
    const parentURL = "https://northeastfoodbank.org/help_center";
    const pageURL = "https://northeastfoodbank.org/help_center/contact";
